...
Event.register(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'../../samurai/en/lightbox/loading.gif',
		expandimg:'../../samurai/en/lightbox/expand.gif',
		shrinkimg:'lightbox/shrink.gif',
		previmg:'../../samurai/en/lightbox/prev.gif',
		nextimg:'../../samurai/en/lightbox/next.gif',
/*		effectpos:{x:-40,y:-20},
		effectclass:'effectable',*/
		closeimg:'../../samurai/en/lightbox/close.gif',
		resizable:true
	});
});
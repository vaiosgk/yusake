...
addEvent(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'/diary/themes/custom/loading.gif',
		expandimg:'/diary/themes/custom/expand.gif',
		shrinkimg:'/diary/themes/custom/shrink.gif',
		effectimg:'zzoop.gif',
		effectpos:{x:-40,y:-20},
		effectclass:'effectable',
		closeimg:'/diary/themes/custom/close.gif'
	});
});
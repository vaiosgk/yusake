...
Event.register(window, "load", function() {
    var lightbox = new LightBox({
        loadingimg:'themes/custom/lightbox/loading.gif',
        expandimg:'themes/custom/lightbox/expand.gif',
        shrinkimg:'themes/custom/lightbox/shrink.gif',
        previmg:'themes/custom/lightbox/prev.gif',
        nextimg:'themes/custom/lightbox/next.gif',
    /*		effectpos:{x:-40,y:-20},
         effectclass:'effectable',*/
        closeimg:'themes/custom/lightbox/close.gif',
        resizable:true
    });
});